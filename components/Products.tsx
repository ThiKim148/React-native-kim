...
const Sanpham23pnv1b = () => {
  return (
      <View style={styles.productList}>
        <Card name="San1" price={12} image={require('../../assets/book_images/hinh1.jpg')}/>
        <Card name="San2" price={12} image={require('../../assets/book_images/hinh1.jpg')}/>
        <Card name="San3" price={12} image={require('../../assets/book_images/hinh1.jpg')}/>
        <Card name="San1" price={12} image={require('../../assets/book_images/hinh1.jpg')}/>
        <Card name="San1" price={12} image={require('../../assets/book_images/hinh1.jpg')}/>
        <Card name="San1" price={12} image={require('../../assets/book_images/hinh1.jpg')}/>
        <Card name="San1" price={12} image={require('../../assets/book_images/hinh1.jpg')}/>
